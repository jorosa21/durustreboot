...
export class FileUploadComponent implements OnInit {
  private uri = environment.apiUrl + "DataUploadManagement/";
  ...
  public uploadFile = (event: any) => {
    ...
    this.http.post('http://168.63.254.218:1015/api/DataUploadManagement/attendance_log_temp?series_code=' + sessionStorage.getItem('sc') + "&created_by=" + sessionStorage.getItem('u'), formData, {reportProgress: true, observe: 'events'})
      .subscribe(event => {
